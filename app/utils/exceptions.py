...
class BrokerConnectionError(AppException):
    ...
    def __init__(
        self, message: str = "Broker connection failed", details: dict | None = None
    ):
...
class BrokerTimeoutError(AppException):
    ...
    def __init__(
        self, message: str = "Broker API request timed out", details: dict | None = None
    ):
...
class BrokerAuthenticationError(AppException):
    ...
    def __init__(
        self, message: str = "Broker authentication failed", details: dict | None = None
    ):
        super().__init__(message, status_code=502, details=details)
...
class BrokerRateLimitError(AppException):
    ...
    def __init__(
        self,
        message: str = "Broker API rate limit exceeded",
...
class PortfolioSyncError(AppException):
    ...
    def __init__(
        self, message: str = "Portfolio sync failed", details: dict | None = None
    ):
...
class CSVParseError(AppException):
    ...
    def __init__(
        self, message: str = "CSV parsing failed", details: dict | None = None
    ):
...
class EncryptionError(AppException):
    ...
    def __init__(
        self, message: str = "Encryption operation failed", details: dict | None = None
    ):
        super().__init__(message, status_code=500, details=details)
